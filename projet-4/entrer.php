...
<button  class="btn btn-md btn-outline-dark shadow-none " data-bs-toggle="modal" data-bs-target="#Modalprint" style="position:absolute;right:12px;top:20px;" ><i class='fas fa-print'></i></button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row text-center" aling="center">
             ...
             <input   name="etat" value="e" hidden> 
          <div class="col-6">
...
<?php endwhile; ?>
    ...
    <div class="row">
        ...
        <div class="">
        <br> <centre><div style="position:absolute;width: 350;top:0;right:-65;z-index: 1;" > <?php if(isset($message)){echo $message;} ?></div> </centre>   
        <?php   
        $result=mysqli_query($con,"SELECT MAX(id) FROM reste");
  while($row =$result ->fetch_assoc()): 
?>
        <div>
            <h5>Nombre des produits dans le stock : <?php echo $row['MAX(id)']; ?></h5>
        </div> 
        <?php endwhile ?>
      ...
      <div id="formEntrer" >
        <div class="modal" id="myModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Ajouter Nouveau Quantité</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                                ...
                                <input autocomplete="off" type="text" class="form-control border-1 border-info"  id="myInput" onkeyup="myFunctionfiltersearch1()"  name="reference"  required   placeholder="Réference" >
  ...
  <li ><div class="list-group-item list-group-item-action" onclick="ref(<?php echo $i; ?>);" >
    <span  class=""  id="<?php echo $i; ?>" > <?php echo $rowsearch['ref']; ?></span> ===><?php echo $rowsearch['nproduit']; ?></div></li>
<?php endwhile; ?>
</ul>
                            </div>
                            <div class="mb-3">
                                <label class="form-label required">Quantité :</label>
                                <input type="text" class="form-control border-info" name="qtte"   required  placeholder="Quantité">
                            </div>
   ...
   <div class="row" >
        <br>
            ...
            <div class="col-12">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal"> Nouveau Quantité</button> 
...
<div class="row " align="center" >
                    ...
                    <table id="table"   class="table-sm table-hover table-bordered  bg-light" style="  display: block; max-height:400px;overflow-y: scroll;width:650px;" >
							<thead>
								<tr class="row100 head">
									<th class="bg-dark text-light" style="width: 150px;"> Réference</th>
									<th class="bg-dark text-light" style="width: 150px;">Produit</th>
									<th class="bg-dark text-light" style="width: 150px;">Quantité Entrée</th>
									<th class="bg-dark text-light" style="width: 180px;">Date</th>
								</tr>
							</thead>
				
							<tbody >
                            <?php 
                            $result=mysqli_query($con,"SELECT * FROM entrer ORDER BY id DESC");
                             while($row =$result ->fetch_assoc()): 
                           ?>
                               <tr class="row100 body" >
                                   <td class="cell100 column1" ><?php echo $row['ref']; ?></td>
                                   <td class="cell100 column2"><?php echo $row['produit']; ?></td>
                                   <td class="cell100 column3"><?php echo $row['qtte']; ?></td>
